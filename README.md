...
A Django web application demonstrating API integration with two different endpoints: OpenWeather API for real-time weather data and a custom REST API for employee management.

## 🌟 Features

### 1. Weather Data Fetching
- Fetches real-time weather information from OpenWeather API
...
- **Example**: `http://localhost:9000/weather/?city=Dhaka`
...
2. Enter a city name (e.g., Dhaka, London, Tokyo)
3. Click "Search" to fetch weather data
4. View temperature, humidity, and weather conditions
...
│
├── employe/
│   ├── views.py          # API integration logic
│   └── templates/
│       └── employe/
│           ├── show.html       # Weather template
│           └── check_api.html  # Employee template
│
